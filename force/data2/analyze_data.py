...
# 파일이 저장된 디렉토리 경로 (예시)
directory_path = './force/data2'

# 결합된 파일을 저장할 디렉토리 경로 (예시)
output_directory_path = './force/data2/combined_data'
...
for base_name in base_names:
    ...
    if os.path.exists(txt_file_path) and os.path.exists(csv_file_path):
        ...
        # 결과 파일로 저장
        output_file_path = os.path.join(output_directory_path, f"{base_name}_combined.csv")
...
# 파일이 저장된 디렉토리 경로 (예시)
directory_path = './force/data2/combined_data'

...
import os
from main.gui_module import show_name_window, show_time_window, show_feedback_window
from main.unity import receving_thermal
...
maxforce_list, rendering_list, temperature_list = receving_thermal(filepath)

output_dir = os.path.join(script_dir, 'multimodal_data')
csv_filepath = os.path.join(output_dir, f'{name}.csv')
